...
class IMGUI_API TextEditor {
  ...
  private:
    ...
    void SetSelection(int aStartLine, int aStartChar, int aEndLine,
                      int aEndChar, int aCursor = -1);
    ...
    Coordinates GetSanitizedCursorCoordinates(int  aCursor = -1,
    ...
    float mTextStart = 20.0f; // position (in pixels) where a code line starts
                              // relative to the left of the TextEditor.
    int         mLeftMargin = 10;
    ImVec2      mCharAdvance;
